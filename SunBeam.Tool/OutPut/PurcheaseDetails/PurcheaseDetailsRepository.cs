...
cmd.Parameters.AddWithValue("@ProReturn", entity.ProReturn);
...
oPurcheaseDetails.ProReturn = Helper.ColumnExists(reader, "ProReturn") ? ((reader["ProReturn"] == DBNull.Value) ? false : Convert.ToBoolean(reader["ProReturn"])) : false;
